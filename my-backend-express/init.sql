...
VALUES 
    (180, '2025-04-01', '2025-09-30', 263.76, TRUE, 1, 3),
    (30, '2025-04-01', '2025-04-30', 31.96, TRUE, 2, 1);
...
VALUES 
    ('2025-04-07 10:00:00', 1, 1),
    ('2025-04-08 10:00:00', 1, 2),
    ('2025-04-09 10:00:00', 1, 3),
    ('2025-04-10 10:00:00', 2, 4),
    ('2025-04-11 10:00:00', 2, 5),
    ('2025-04-12 10:00:00', 2, 6);

INSERT INTO PAIEMENT (montant_paiement, date_paiement, type_paiement, id_cours, id_achat, id_abonnement, id_inscrit)
VALUES 
    (20.00, '2025-04-07', 'carte', 1, NULL, NULL, 1),
    (25.00, '2025-04-08', 'paypal', 2, NULL, NULL, 1),
    (22.00, '2025-04-09', 'virement', 3, NULL, NULL, 1),
    (30.00, '2025-04-10', 'carte', 4, NULL, NULL, 2),
    (28.00, '2025-04-11', 'paypal', 5, NULL, NULL, 2),
    (35.00, '2025-04-12', 'virement', 6, NULL, NULL, 2),
    (263.76, '2025-04-01', 'carte', NULL, NULL, 1, 1),
    (31.96, '2025-04-01', 'carte', NULL, NULL, 2, 2),
    (80.00, '2025-04-10', 'carte', NULL, 1, NULL, 1),
    (15.00, '2025-04-12', 'carte', NULL, 2, NULL, 2);